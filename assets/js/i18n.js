...
(function (root, factory) {
  ...
  var STR = {
    ...
    'step1.title': { fr: 'Que voulez-vous obtenir ?', en: 'What do you want?' },
    'step1.hint': { fr: 'Écrivez-le comme vous le diriez à un collègue. Une phrase suffit.', en: 'Write it the way you would say it to a colleague. One sentence is enough.' },
    'step2.title': { fr: 'Pour quelle IA ?', en: 'For which AI?' },
    'step2.hint': { fr: 'Le format et les consignes du prompt s\'adaptent à la destination.', en: 'The prompt format and instructions adapt to the destination.' },
    'composer.browse': { fr: 'Parcourir les modèles', en: 'Browse templates' },
    'composer.reset': { fr: 'Réinitialiser les réglages', en: 'Reset settings' },
    'toggles.legend': { fr: 'Éléments inclus dans le prompt', en: 'Blocks included in the prompt' },

    'target.claude.name': { fr: 'Claude', en: 'Claude' },
    'target.claude.desc': { fr: 'Sections balisées, le format qu\'il suit le mieux.', en: 'Tagged sections, the format it follows best.' },
    'target.gpt.name': { fr: 'ChatGPT', en: 'ChatGPT' },
    'target.gpt.desc': { fr: 'Markdown structuré, titres explicites.', en: 'Structured markdown, explicit headings.' },
    'target.gemini.name': { fr: 'Gemini', en: 'Gemini' },
    'target.gemini.desc': { fr: 'Réponse complète en une seule passe.', en: 'Complete answer in a single pass.' },
    'target.mistral.name': { fr: 'Mistral', en: 'Mistral' },
    'target.mistral.desc': { fr: 'Markdown structuré, consignes ordonnées.', en: 'Structured markdown, ordered instructions.' },
    'target.claudecode.name': { fr: 'Claude Code', en: 'Claude Code' },
    'target.claudecode.desc': { fr: 'Brief d\'agent : périmètre, vérification, livraison.', en: 'Agent brief: scope, verification, delivery.' },
    'target.image.name': { fr: 'Génération d\'images', en: 'Image generation' },
    'target.image.desc': { fr: 'Midjourney, DALL·E, Stable Diffusion…', en: 'Midjourney, DALL·E, Stable Diffusion…' },
    'target.any.name': { fr: 'Peu importe', en: 'No preference' },
    'target.any.desc': { fr: 'Un prompt universel, lisible partout.', en: 'A universal prompt, readable anywhere.' },
    'target.badge': { fr: 'Nouveau', en: 'New' },

    'agent.title': { fr: 'Contexte du dépôt — facultatif, mais le prompt sera bien meilleur', en: 'Repository context — optional, but the prompt gets much better' },
    'field.stack': { fr: 'Stack et versions', en: 'Stack and versions' },
    'field.stack.ph': { fr: 'ex. Node 22, React 19, PostgreSQL', en: 'e.g. Node 22, React 19, PostgreSQL' },
    'field.files': { fr: 'Fichiers ou dossiers concernés', en: 'Files or folders involved' },
    'field.files.ph': { fr: 'ex. src/api/, tests/auth.test.ts', en: 'e.g. src/api/, tests/auth.test.ts' },
    'field.test': { fr: 'Commande de vérification', en: 'Verification command' },
    'field.test.ph': { fr: 'ex. npm test, pytest -q', en: 'e.g. npm test, pytest -q' },

    'summary.setting': { fr: 'réglage modifié', en: 'setting changed' },
    'summary.settings': { fr: 'réglages modifiés', en: 'settings changed' },
    'summary.default': { fr: 'réglages par défaut', en: 'default settings' },
